...
const Features = () => {
  return (
    <section className="bg-[#edeecb] pt-10 lg:pt-20 m-10" style={{ fontFamily: 'Garamond, serif' }}>
      {/* Heading aligned to the left */}
      <h2 className="text-[#de5c0a] text-3xl sm:text-4xl font-bold mb-10">
        FEATURES
      </h2>

      {/* Features Section */}
      <div className="flex flex-wrap justify-start gap-10 sm:gap-8 py-5 px-10">
