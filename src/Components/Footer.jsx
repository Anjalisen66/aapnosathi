...
const Footer = () => {
  return (
      <div className="bg-[#edeecb] text-[#7a3b1c] p-8 md:p-12" style={{ fontFamily: 'Garamond, serif', position: 'relative' }}>
       <div className="border-t-4 border-[#de5c0a] absolute left-0 right-0 top-0 mb-8"></div>
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
              <div className='max-w-200'>
                  <img  src={logo} alt="logo" className='mb-4 h-12 md:h-16 w-auto' />
                  <p className='text-md font-medium'  style={{ fontFamily: 'Garamond, serif', position: 'relative' }}>
              ...
              <div style={{ fontFamily: 'Garamond, serif', position: 'relative' }}>
